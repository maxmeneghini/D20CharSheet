...
st.markdown(
    ...
    <style>
      ...
      /* =========================
         HIT POINTS CARD (compact)
         ========================= */
      .hp-first .stButton>button{ padding:.06rem .28rem; font-size:.65rem; border-radius:.4rem; height:22px; line-height:1; }
      .hp-first div[data-testid="stNumberInput"] input{ height:22px; font-size:.74rem; padding:1px 4px; }
      .hp-first [data-testid="stVerticalBlock"]{ padding-top:.02rem; padding-bottom:.02rem; margin:0 !important; }
      .hp-first .stNumberInput, .hp-first .stButton{ margin:0 !important; }

      .hp-mid{ display:flex; flex-direction:column; justify-content:space-between; height:100%; }
      .hp-mid .labels{ display:flex; justify-content:center; gap:2rem; text-transform:uppercase; font-size:.85rem; letter-spacing:.08em; color:#333; margin-bottom:.04rem; }
      .hp-mid .hp-footer{ text-transform:uppercase; font-weight:700; font-size:1.2rem; color:#333; text-align:center; margin-top:.04rem; }
      .hp-mid .big-number{ font-size:1.45rem; }

      .hp-side div[data-testid="stNumberInput"]{ max-width:84px; margin:0 !important; }
      .hp-side input{ height:22px; font-size:.74rem; padding:1px 4px; }
      .hp-side .small-label{ margin-bottom:.08rem; font-size:.68rem; }
    </style>
    """,
